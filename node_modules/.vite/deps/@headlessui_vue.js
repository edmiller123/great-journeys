...
function y3(f5, c5, i4 = computed(() => true)) {
  function a7(e4, r4) {
    ...
    if (t6 === null || !t6.getRootNode().contains(t6))
      return;
    let m5 = function o4(n6) {
      return typeof n6 == "function" ? o4(n6()) : Array.isArray(n6) || n6 instanceof Set ? n6 : [n6];
    }(f5);
    for (let o4 of m5) {
      if (o4 === null)
        continue;
      let n6 = o4 instanceof HTMLElement ? o4 : o2(o4);
  ...
  u2("pointerdown", (e4) => {
    var r4, t6;
    i4.value && (u6.value = ((t6 = (r4 = e4.composedPath) == null ? void 0 : r4.call(e4)) == null ? void 0 : t6[0]) || e4.target);
...
var xe = ((s3) => (s3[s3.Open = 0] = "Open", s3[s3.Closed = 1] = "Closed", s3))(xe || {});
var Ce = ((s3) => (s3[s3.Single = 0] = "Single", s3[s3.Multi = 1] = "Multi", s3))(Ce || {});
var Oe = ((s3) => (s3[s3.Pointer = 0] = "Pointer", s3[s3.Other = 1] = "Other", s3))(Oe || {});
var X = Symbol("ComboboxContext");
function H3(o4) {
  let R2 = inject(X, null);
  if (R2 === null) {
    let s3 = new Error(`<${o4} /> is missing a parent <Combobox /> component.`);
    throw Error.captureStackTrace && Error.captureStackTrace(s3, H3), s3;
  }
  return R2;
}
var Ue = defineComponent({ name: "Combobox", emits: { "update:modelValue": (o4) => true }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => ce }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, nullable: { type: Boolean, default: false }, multiple: { type: [Boolean], default: false } }, inheritAttrs: false, setup(o4, { slots: R2, attrs: s3, emit: V3 }) {
  let e4 = ref(1), t6 = ref(null), d8 = ref(null), P3 = ref(null), p9 = ref(null), m5 = ref({ static: false, hold: false }), x4 = ref([]), C3 = ref(null), h4 = ref(1), T4 = ref(false);
  function E6(a7 = (u6) => u6) {
    let u6 = C3.value !== null ? x4.value[C3.value] : null, f5 = O(a7(x4.value.slice()), (v4) => o2(v4.dataRef.domRef)), r4 = u6 ? f5.indexOf(u6) : null;
    return r4 === -1 && (r4 = null), { options: f5, activeOptionIndex: r4 };
  }
  let n6 = computed(() => o4.multiple ? 1 : 0), l4 = computed(() => o4.nullable), [b4, w3] = d2(computed(() => o4.modelValue === void 0 ? u(n6.value, { [1]: [], [0]: void 0 }) : o4.modelValue), (a7) => V3("update:modelValue", a7), computed(() => o4.defaultValue)), S5 = null, D = null, i4 = { comboboxState: e4, value: b4, mode: n6, compare(a7, u6) {
    if (typeof o4.by == "string") {
      let f5 = o4.by;
      return (a7 == null ? void 0 : a7[f5]) === (u6 == null ? void 0 : u6[f5]);
    }
    return o4.by(a7, u6);
  }, defaultValue: computed(() => o4.defaultValue), nullable: l4, inputRef: d8, labelRef: t6, buttonRef: P3, optionsRef: p9, disabled: computed(() => o4.disabled), options: x4, change(a7) {
    w3(a7);
  }, activeOptionIndex: computed(() => {
    if (T4.value && C3.value === null && x4.value.length > 0) {
      let a7 = x4.value.findIndex((u6) => !u6.dataRef.disabled);
      a7 !== -1 && (C3.value = a7);
    }
    return C3.value;
  }), activationTrigger: h4, optionsPropsRef: m5, closeCombobox() {
    T4.value = false, !o4.disabled && e4.value !== 1 && (e4.value = 1, C3.value = null);
  }, openCombobox() {
    if (T4.value = true, o4.disabled || e4.value === 0)
      return;
    let a7 = x4.value.findIndex((u6) => {
      let f5 = toRaw(u6.dataRef.value);
      return u(n6.value, { [0]: () => i4.compare(toRaw(i4.value.value), toRaw(f5)), [1]: () => toRaw(i4.value.value).some((v4) => i4.compare(toRaw(v4), toRaw(f5))) });
    });
    a7 !== -1 && (C3.value = a7), e4.value = 0;
  }, goToOption(a7, u6, f5) {
    S5 !== null && cancelAnimationFrame(S5), S5 = requestAnimationFrame(() => {
      if (T4.value = false, o4.disabled || p9.value && !m5.value.static && e4.value === 1)
        return;
      let r4 = E6();
      if (r4.activeOptionIndex === null) {
        let y4 = r4.options.findIndex((L4) => !L4.dataRef.disabled);
        y4 !== -1 && (r4.activeOptionIndex = y4);
      }
      let v4 = x(a7 === a.Specific ? { focus: a.Specific, id: u6 } : { focus: a7 }, { resolveItems: () => r4.options, resolveActiveIndex: () => r4.activeOptionIndex, resolveId: (y4) => y4.id, resolveDisabled: (y4) => y4.dataRef.disabled });
      C3.value = v4, h4.value = f5 != null ? f5 : 1, x4.value = r4.options;
    });
  }, selectOption(a7) {
    let u6 = x4.value.find((r4) => r4.id === a7);
    if (!u6)
      return;
    let { dataRef: f5 } = u6;
    w3(u(n6.value, { [0]: () => f5.value, [1]: () => {
      let r4 = toRaw(i4.value.value).slice(), v4 = toRaw(f5.value), y4 = r4.findIndex((L4) => i4.compare(v4, toRaw(L4)));
      return y4 === -1 ? r4.push(v4) : r4.splice(y4, 1), r4;
    } }));
  }, selectActiveOption() {
    if (i4.activeOptionIndex.value === null)
      return;
    let { dataRef: a7, id: u6 } = x4.value[i4.activeOptionIndex.value];
    w3(u(n6.value, { [0]: () => a7.value, [1]: () => {
      let f5 = toRaw(i4.value.value).slice(), r4 = toRaw(a7.value), v4 = f5.findIndex((y4) => i4.compare(r4, toRaw(y4)));
      return v4 === -1 ? f5.push(r4) : f5.splice(v4, 1), f5;
    } })), i4.goToOption(a.Specific, u6);
  }, registerOption(a7, u6) {
    D && cancelAnimationFrame(D);
    let f5 = { id: a7, dataRef: u6 }, r4 = E6((v4) => (v4.push(f5), v4));
    if (C3.value === null) {
      let v4 = u6.value.value;
      u(n6.value, { [0]: () => i4.compare(toRaw(i4.value.value), toRaw(v4)), [1]: () => toRaw(i4.value.value).some((L4) => i4.compare(toRaw(L4), toRaw(v4))) }) && (r4.activeOptionIndex = r4.options.indexOf(f5));
    }
    x4.value = r4.options, C3.value = r4.activeOptionIndex, h4.value = 1, r4.options.some((v4) => !o2(v4.dataRef.domRef)) && (D = requestAnimationFrame(() => {
      let v4 = E6();
      x4.value = v4.options, C3.value = v4.activeOptionIndex;
    }));
  }, unregisterOption(a7) {
    var f5;
    i4.activeOptionIndex.value !== null && ((f5 = i4.options.value[i4.activeOptionIndex.value]) == null ? void 0 : f5.id) === a7 && (T4.value = true);
    let u6 = E6((r4) => {
      let v4 = r4.findIndex((y4) => y4.id === a7);
      return v4 !== -1 && r4.splice(v4, 1), r4;
    });
    x4.value = u6.options, C3.value = u6.activeOptionIndex, h4.value = 1;
  } };
  y3([d8, P3, p9], () => i4.closeCombobox(), computed(() => e4.value === 0)), provide(X, i4), c(computed(() => u(e4.value, { [0]: l.Open, [1]: l.Closed })));
  let $2 = computed(() => i4.activeOptionIndex.value === null ? null : x4.value[i4.activeOptionIndex.value].dataRef.value), F4 = computed(() => {
    var a7;
    return (a7 = o2(d8)) == null ? void 0 : a7.closest("form");
  });
  return onMounted(() => {
    watch([F4], () => {
      if (!F4.value || o4.defaultValue === void 0)
        return;
      function a7() {
        i4.change(o4.defaultValue);
      }
      return F4.value.addEventListener("reset", a7), () => {
        var u6;
        (u6 = F4.value) == null || u6.removeEventListener("reset", a7);
      };
    }, { immediate: true });
  }), () => {
    let { name: a7, disabled: u6, form: f5, ...r4 } = o4, v4 = { open: e4.value === 0, disabled: u6, activeIndex: i4.activeOptionIndex.value, activeOption: $2.value, value: b4.value };
    return h(Fragment, [...a7 != null && b4.value != null ? e2({ [a7]: b4.value }).map(([y4, L4]) => h(f2, K({ features: a2.Hidden, key: y4, as: "input", type: "hidden", hidden: true, readOnly: true, form: f5, name: y4, value: L4 }))) : [], H({ theirProps: { ...s3, ...T(r4, ["modelValue", "defaultValue", "nullable", "multiple", "onUpdate:modelValue", "by"]) }, ourProps: {}, slot: v4, slots: R2, attrs: s3, name: "Combobox" })]);
  };
} });
var qe = defineComponent({ name: "ComboboxLabel", props: { as: { type: [Object, String], default: "label" }, id: { type: String, default: () => `headlessui-combobox-label-${t()}` } }, setup(o4, { attrs: R2, slots: s3 }) {
  let V3 = H3("ComboboxLabel");
  function e4() {
    var t6;
    (t6 = o2(V3.inputRef)) == null || t6.focus({ preventScroll: true });
  }
  return () => {
    let t6 = { open: V3.comboboxState.value === 0, disabled: V3.disabled.value }, { id: d8, ...P3 } = o4, p9 = { id: d8, ref: V3.labelRef, onClick: e4 };
    return H({ ourProps: p9, theirProps: P3, slot: t6, attrs: R2, slots: s3, name: "ComboboxLabel" });
  };
} });
var _e = defineComponent({ name: "ComboboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: () => `headlessui-combobox-button-${t()}` } }, setup(o4, { attrs: R2, slots: s3, expose: V3 }) {
  let e4 = H3("ComboboxButton");
  V3({ el: e4.buttonRef, $el: e4.buttonRef });
  function t6(p9) {
    e4.disabled.value || (e4.comboboxState.value === 0 ? e4.closeCombobox() : (p9.preventDefault(), e4.openCombobox()), nextTick(() => {
      var m5;
      return (m5 = o2(e4.inputRef)) == null ? void 0 : m5.focus({ preventScroll: true });
    }));
  }
  function d8(p9) {
    switch (p9.key) {
      case o.ArrowDown:
        p9.preventDefault(), p9.stopPropagation(), e4.comboboxState.value === 1 && e4.openCombobox(), nextTick(() => {
          var m5;
          return (m5 = e4.inputRef.value) == null ? void 0 : m5.focus({ preventScroll: true });
        });
        return;
      case o.ArrowUp:
        p9.preventDefault(), p9.stopPropagation(), e4.comboboxState.value === 1 && (e4.openCombobox(), nextTick(() => {
      ...
      case o.Escape:
        if (e4.comboboxState.value !== 0)
          return;
        p9.preventDefault(), e4.optionsRef.value && !e4.optionsPropsRef.value.static && p9.stopPropagation(), e4.closeCombobox(), nextTick(() => {
          var m5;
          return (m5 = e4.inputRef.value) == null ? void 0 : m5.focus({ preventScroll: true });
        });
        return;
  ...
  let P3 = b2(computed(() => ({ as: o4.as, type: R2.type })), e4.buttonRef);
  return () => {
    var h4, T4;
    let p9 = { open: e4.comboboxState.value === 0, disabled: e4.disabled.value, value: e4.value.value }, { id: m5, ...x4 } = o4, C3 = { ref: e4.buttonRef, id: m5, type: P3.value, tabindex: "-1", "aria-haspopup": "listbox", "aria-controls": (h4 = o2(e4.optionsRef)) == null ? void 0 : h4.id, "aria-expanded": e4.comboboxState.value === 0, "aria-labelledby": e4.labelRef.value ? [(T4 = o2(e4.labelRef)) == null ? void 0 : T4.id, m5].join(" ") : void 0, disabled: e4.disabled.value === true ? true : void 0, onKeydown: d8, onClick: t6 };
    return H({ ourProps: C3, theirProps: x4, slot: p9, attrs: R2, slots: s3, name: "ComboboxButton" });
  };
} });
var Je = defineComponent({ name: "ComboboxInput", props: { as: { type: [Object, String], default: "input" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, displayValue: { type: Function }, defaultValue: { type: String, default: void 0 }, id: { type: String, default: () => `headlessui-combobox-input-${t()}` } }, emits: { change: (o4) => true }, setup(o4, { emit: R2, attrs: s3, slots: V3, expose: e4 }) {
  let t6 = H3("ComboboxInput"), d8 = { value: false };
  e4({ el: t6.inputRef, $el: t6.inputRef });
  let P3 = computed(() => {
    var l4;
    let n6 = t6.value.value;
    return o2(t6.inputRef) ? typeof o4.displayValue != "undefined" && n6 !== void 0 ? (l4 = o4.displayValue(n6)) != null ? l4 : "" : typeof n6 == "string" ? n6 : "" : "";
  });
  onMounted(() => {
    watch([P3, t6.comboboxState], ([n6, l4], [b4, w3]) => {
      if (d8.value)
        return;
      let S5 = o2(t6.inputRef);
      S5 && ((w3 === 0 && l4 === 1 || n6 !== b4) && (S5.value = n6), requestAnimationFrame(() => {
        if (d8.value || !S5)
          return;
        let { selectionStart: D, selectionEnd: i4 } = S5;
        Math.abs((i4 != null ? i4 : 0) - (D != null ? D : 0)) === 0 && D === 0 && S5.setSelectionRange(S5.value.length, S5.value.length);
      }));
    }, { immediate: true }), watch([t6.comboboxState], ([n6], [l4]) => {
      if (n6 === 0 && l4 === 1) {
        if (d8.value)
          return;
        ...
        if (!b4)
          return;
        let w3 = b4.value, { selectionStart: S5, selectionEnd: D, selectionDirection: i4 } = b4;
        b4.value = "", b4.value = w3, i4 !== null ? b4.setSelectionRange(S5, D, i4) : b4.setSelectionRange(S5, D);
      }
    });
  });
  let p9 = ref(false);
  ...
  function C3(n6) {
    switch (d8.value = true, n6.key) {
      case o.Backspace:
      case o.Delete:
        if (t6.mode.value !== 0 || !t6.nullable.value)
          return;
        let l4 = n6.currentTarget;
        ...
        break;
      case o.Enter:
        if (d8.value = false, t6.comboboxState.value !== 0 || p9.value)
          return;
        if (n6.preventDefault(), n6.stopPropagation(), t6.activeOptionIndex.value === null) {
          t6.closeCombobox();
          return;
        }
        ...
        break;
      case o.ArrowDown:
        return d8.value = false, n6.preventDefault(), n6.stopPropagation(), u(t6.comboboxState.value, { [0]: () => t6.goToOption(a.Next), [1]: () => t6.openCombobox() });
      case o.ArrowUp:
        return d8.value = false, n6.preventDefault(), n6.stopPropagation(), u(t6.comboboxState.value, { [0]: () => t6.goToOption(a.Previous), [1]: () => {
      ...
      case o.Home:
        if (n6.shiftKey)
          break;
        return d8.value = false, n6.preventDefault(), n6.stopPropagation(), t6.goToOption(a.First);
      case o.PageUp:
        return d8.value = false, n6.preventDefault(), n6.stopPropagation(), t6.goToOption(a.First);
      case o.End:
        if (n6.shiftKey)
          break;
        return d8.value = false, n6.preventDefault(), n6.stopPropagation(), t6.goToOption(a.Last);
      case o.PageDown:
        return d8.value = false, n6.preventDefault(), n6.stopPropagation(), t6.goToOption(a.Last);
      case o.Escape:
        if (d8.value = false, t6.comboboxState.value !== 0)
          return;
        n6.preventDefault(), t6.optionsRef.value && !t6.optionsPropsRef.value.static && n6.stopPropagation(), t6.closeCombobox();
        break;
      case o.Tab:
        if (d8.value = false, t6.comboboxState.value !== 0)
          return;
  ...
  let E6 = computed(() => {
    var n6, l4, b4, w3;
    return (w3 = (b4 = (l4 = o4.defaultValue) != null ? l4 : t6.defaultValue.value !== void 0 ? (n6 = o4.displayValue) == null ? void 0 : n6.call(o4, t6.defaultValue.value) : null) != null ? b4 : t6.defaultValue.value) != null ? w3 : "";
  });
  return () => {
    var i4, $2, F4, a7, u6, f5;
    let n6 = { open: t6.comboboxState.value === 0 }, { id: l4, displayValue: b4, onChange: w3, ...S5 } = o4, D = { "aria-controls": (i4 = t6.optionsRef.value) == null ? void 0 : i4.id, "aria-expanded": t6.comboboxState.value === 0, "aria-activedescendant": t6.activeOptionIndex.value === null || ($2 = t6.options.value[t6.activeOptionIndex.value]) == null ? void 0 : $2.id, "aria-labelledby": (u6 = (F4 = o2(t6.labelRef)) == null ? void 0 : F4.id) != null ? u6 : (a7 = o2(t6.buttonRef)) == null ? void 0 : a7.id, "aria-autocomplete": "list", id: l4, onCompositionstart: m5, onCompositionend: x4, onKeydown: C3, onInput: h4, onBlur: T4, role: "combobox", type: (f5 = s3.type) != null ? f5 : "text", tabIndex: 0, ref: t6.inputRef, defaultValue: E6.value, disabled: t6.disabled.value === true ? true : void 0 };
    return H({ ourProps: D, theirProps: S5, slot: n6, attrs: s3, slots: V3, features: N.RenderStrategy | N.Static, name: "ComboboxInput" });
  };
} });
var We = defineComponent({ name: "ComboboxOptions", props: { as: { type: [Object, String], default: "ul" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, hold: { type: [Boolean], default: false } }, setup(o4, { attrs: R2, slots: s3, expose: V3 }) {
  let e4 = H3("ComboboxOptions"), t6 = `headlessui-combobox-options-${t()}`;
  V3({ el: e4.optionsRef, $el: e4.optionsRef }), watchEffect(() => {
    e4.optionsPropsRef.value.static = o4.static;
  }), watchEffect(() => {
    e4.optionsPropsRef.value.hold = o4.hold;
  });
  let d8 = p(), P3 = computed(() => d8 !== null ? (d8.value & l.Open) === l.Open : e4.comboboxState.value === 0);
  return p2({ container: computed(() => o2(e4.optionsRef)), enabled: computed(() => e4.comboboxState.value === 0), accept(p9) {
    return p9.getAttribute("role") === "option" ? NodeFilter.FILTER_REJECT : p9.hasAttribute("role") ? NodeFilter.FILTER_SKIP : NodeFilter.FILTER_ACCEPT;
  }, walk(p9) {
    p9.setAttribute("role", "none");
  } }), () => {
    var C3, h4, T4;
    let p9 = { open: e4.comboboxState.value === 0 }, m5 = { "aria-labelledby": (T4 = (C3 = o2(e4.labelRef)) == null ? void 0 : C3.id) != null ? T4 : (h4 = o2(e4.buttonRef)) == null ? void 0 : h4.id, id: t6, ref: e4.optionsRef, role: "listbox", "aria-multiselectable": e4.mode.value === 1 ? true : void 0 }, x4 = T(o4, ["hold"]);
    return H({ ourProps: m5, theirProps: x4, slot: p9, attrs: R2, slots: s3, features: N.RenderStrategy | N.Static, visible: P3.value, name: "ComboboxOptions" });
  };
} });
var Ge = defineComponent({ name: "ComboboxOption", props: { as: { type: [Object, String], default: "li" }, value: { type: [Object, String, Number, Boolean] }, disabled: { type: Boolean, default: false } }, setup(o4, { slots: R2, attrs: s3, expose: V3 }) {
  let e4 = H3("ComboboxOption"), t6 = `headlessui-combobox-option-${t()}`, d8 = ref(null);
  V3({ el: d8, $el: d8 });
  let P3 = computed(() => e4.activeOptionIndex.value !== null ? e4.options.value[e4.activeOptionIndex.value].id === t6 : false), p9 = computed(() => u(e4.mode.value, { [0]: () => e4.compare(toRaw(e4.value.value), toRaw(o4.value)), [1]: () => toRaw(e4.value.value).some((l4) => e4.compare(toRaw(l4), toRaw(o4.value))) })), m5 = computed(() => ({ disabled: o4.disabled, value: o4.value, domRef: d8 }));
  onMounted(() => e4.registerOption(t6, m5)), onUnmounted(() => e4.unregisterOption(t6)), watchEffect(() => {
    e4.comboboxState.value === 0 && P3.value && e4.activationTrigger.value !== 0 && nextTick(() => {
      var l4, b4;
      return (b4 = (l4 = o2(d8)) == null ? void 0 : l4.scrollIntoView) == null ? void 0 : b4.call(l4, { block: "nearest" });
    });
  });
  function x4(l4) {
    if (o4.disabled)
  ...
  function E6(l4) {
    h4.wasMoved(l4) && (o4.disabled || P3.value || e4.goToOption(a.Specific, t6, 0));
  }
  function n6(l4) {
    h4.wasMoved(l4) && (o4.disabled || P3.value && (e4.optionsPropsRef.value.hold || e4.goToOption(a.Nothing)));
  }
  return () => {
    let { disabled: l4 } = o4, b4 = { active: P3.value, selected: p9.value, disabled: l4 }, w3 = { id: t6, ref: d8, role: "option", tabIndex: l4 === true ? void 0 : -1, "aria-disabled": l4 === true ? true : void 0, "aria-selected": p9.value, disabled: void 0, onClick: x4, onFocus: C3, onPointerenter: T4, onMouseenter: T4, onPointermove: E6, onMousemove: E6, onPointerleave: n6, onMouseleave: n6 };
    return H({ ourProps: w3, theirProps: o4, slot: b4, attrs: s3, slots: R2, name: "ComboboxOption" });
  };
} });
...
var ce2 = Object.assign(defineComponent({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: [Object, Function], default: ref(/* @__PURE__ */ new Set()) } }, inheritAttrs: false, setup(e4, { attrs: t6, slots: l4, expose: o4 }) {
  ...
  return () => {
    let a7 = {}, d8 = { ref: r4, onKeydown: H5, onFocusout: M3 }, { features: E6, initialFocus: g5, containers: X3, ...O3 } = e4;
...
var Ue2 = defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: M2 }, initialFocus: { type: Object, default: null }, id: { type: String, default: () => `headlessui-dialog-${t()}` } }, emits: { close: (o4) => true }, setup(o4, { emit: n6, attrs: t6, slots: u6, expose: i4 }) {
  ...
  let c5 = computed(() => r4.value && m5.value ? 0 : 1), R2 = computed(() => c5.value === 0), E6 = computed(() => s3.value > 1), $2 = inject(F2, null) !== null, [G, V3] = V(), { resolveContainers: x4, mainTreeNodeRef: j6, MainTreeNode: W2 } = p7({ portals: G, defaultContainers: [computed(() => {
    var e4;
    return (e4 = y4.panelRef.value) != null ? e4 : v4.value;
  })] }), J2 = computed(() => E6.value ? "parent" : "leaf"), H5 = computed(() => p9 !== null ? (p9.value & l.Closing) === l.Closing : false), Q4 = computed(() => $2 || H5.value ? false : R2.value), X3 = computed(() => {
    var e4, l4, f5;
  ...
  let te2 = M({ name: "DialogDescription", slot: computed(() => ({ open: m5.value })) }), k2 = ref(null), y4 = { titleId: k2, panelRef: ref(null), dialogState: c5, setTitleId(e4) {
...
var Ge2 = defineComponent({ name: "DialogPanel", props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: () => `headlessui-dialog-panel-${t()}` } }, setup(o4, { attrs: n6, slots: t6, expose: u6 }) {
...
function g(l4) {
  ...
  if (r4 === null) {
    let o4 = new Error(`<${l4} /> is missing a parent <Disclosure /> component.`);
...
var Q2 = defineComponent({ name: "Disclosure", props: { as: { type: [Object, String], default: "template" }, defaultOpen: { type: [Boolean], default: false } }, setup(l4, { slots: r4, attrs: o4 }) {
  let u6 = ref(l4.defaultOpen ? 0 : 1), e4 = ref(null), i4 = ref(null), s3 = { buttonId: ref(null), panelId: ref(null), disclosureState: u6, panel: e4, button: i4, toggleDisclosure() {
    u6.value = u(u6.value, { [0]: 1, [1]: 0 });
  }, closeDisclosure() {
    u6.value !== 1 && (u6.value = 1);
  }, close(t6) {
    s3.closeDisclosure();
    let a7 = (() => t6 ? t6 instanceof HTMLElement ? t6 : t6.value instanceof HTMLElement ? o2(t6) : o2(s3.button) : o2(s3.button))();
    a7 == null || a7.focus();
  } };
  return provide(x3, s3), c(computed(() => u(u6.value, { [0]: l.Open, [1]: l.Closed }))), () => {
    let { defaultOpen: t6, ...a7 } = l4, c5 = { open: u6.value === 0, close: s3.close };
    return H({ theirProps: a7, ourProps: {}, slot: c5, slots: r4, attrs: o4, name: "Disclosure" });
  };
} });
var V2 = defineComponent({ name: "DisclosureButton", props: { as: { type: [Object, String], default: "button" }, disabled: { type: [Boolean], default: false }, id: { type: String, default: () => `headlessui-disclosure-button-${t()}` } }, setup(l4, { attrs: r4, slots: o4, expose: u6 }) {
  let e4 = g("DisclosureButton");
  onMounted(() => {
    e4.buttonId.value = l4.id;
  }), onUnmounted(() => {
    e4.buttonId.value = null;
  });
  let i4 = $(), s3 = computed(() => i4 === null ? false : i4.value === e4.panelId.value), t6 = ref(null);
  u6({ el: t6, $el: t6 }), s3.value || watchEffect(() => {
    e4.button.value = t6.value;
  });
  let a7 = b2(computed(() => ({ as: l4.as, type: r4.type })), t6);
  function c5() {
    var n6;
    l4.disabled || (s3.value ? (e4.toggleDisclosure(), (n6 = o2(e4.button)) == null || n6.focus()) : e4.toggleDisclosure());
  }
  function D(n6) {
    var S5;
    if (!l4.disabled)
  ...
  return () => {
    let n6 = { open: e4.disclosureState.value === 0 }, { id: S5, ...k2 } = l4, K3 = s3.value ? { ref: t6, type: a7.value, onClick: c5, onKeydown: D } : { id: S5, ref: t6, type: a7.value, "aria-expanded": e4.disclosureState.value === 0, "aria-controls": o2(e4.panel) ? e4.panelId.value : void 0, disabled: l4.disabled ? true : void 0, onClick: c5, onKeydown: D, onKeyup: T4 };
    return H({ ourProps: K3, theirProps: k2, slot: n6, attrs: r4, slots: o4, name: "DisclosureButton" });
  };
} });
var X2 = defineComponent({ name: "DisclosurePanel", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, id: { type: String, default: () => `headlessui-disclosure-panel-${t()}` } }, setup(l4, { attrs: r4, slots: o4, expose: u6 }) {
  let e4 = g("DisclosurePanel");
  onMounted(() => {
    e4.panelId.value = l4.id;
  }), onUnmounted(() => {
  ...
  return () => {
    let t6 = { open: e4.disclosureState.value === 0, close: e4.close }, { id: a7, ...c5 } = l4, D = { id: a7, ref: e4.panel };
    return H({ ourProps: D, theirProps: c5, slot: t6, attrs: r4, slots: o4, features: N.RenderStrategy | N.Static, visible: s3.value, name: "DisclosurePanel" });
  };
} });
...
var ve = ((u6) => (u6[u6.Pointer = 0] = "Pointer", u6[u6.Other = 1] = "Other", u6))(ve || {});
function be(t6) {
...
var Fe = defineComponent({ name: "Listbox", emits: { "update:modelValue": (t6) => true }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => fe }, horizontal: { type: [Boolean], default: false }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, multiple: { type: [Boolean], default: false } }, inheritAttrs: false, setup(t6, { slots: v4, attrs: u6, emit: L4 }) {
  ...
  let g5 = computed(() => t6.multiple ? 1 : 0), [y4, M3] = d2(computed(() => t6.modelValue === void 0 ? u(g5.value, { [1]: [], [0]: void 0 }) : t6.modelValue), (i4) => L4("update:modelValue", i4), computed(() => t6.defaultValue)), h4 = { listboxState: e4, value: y4, mode: g5, compare(i4, n6) {
  ...
  return onMounted(() => {
    ...
    let { name: i4, modelValue: n6, disabled: l4, form: d8, ...x4 } = t6, R2 = { open: e4.value === 0, disabled: l4, value: y4.value };
    return h(Fragment, [...i4 != null && y4.value != null ? e2({ [i4]: y4.value }).map(([V3, $2]) => h(f2, K({ features: a2.Hidden, key: V3, as: "input", type: "hidden", hidden: true, readOnly: true, form: d8, name: V3, value: $2 }))) : [], H({ ourProps: {}, theirProps: { ...u6, ...T(x4, ["defaultValue", "onUpdate:modelValue", "horizontal", "multiple", "by"]) }, slot: R2, slots: v4, attrs: u6, name: "Listbox" })]);
  };
} });
...
var Ke = defineComponent({ name: "ListboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: () => `headlessui-listbox-button-${t()}` } }, setup(t6, { attrs: v4, slots: u6, expose: L4 }) {
...
var Ne = defineComponent({ name: "ListboxOptions", props: { as: { type: [Object, String], default: "ul" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, id: { type: String, default: () => `headlessui-listbox-options-${t()}` } }, setup(t6, { attrs: v4, slots: u6, expose: L4 }) {
  ...
  return () => {
    var g5, y4, M3, h4;
    let o4 = { open: e4.listboxState.value === 0 }, { id: a7, ...w3 } = t6, k2 = { "aria-activedescendant": e4.activeOptionIndex.value === null || (g5 = e4.options.value[e4.activeOptionIndex.value]) == null ? void 0 : g5.id, "aria-multiselectable": e4.mode.value === 1 ? true : void 0, "aria-labelledby": (h4 = (y4 = o2(e4.labelRef)) == null ? void 0 : y4.id) != null ? h4 : (M3 = o2(e4.buttonRef)) == null ? void 0 : M3.id, "aria-orientation": e4.orientation.value, id: a7, onKeydown: b4, role: "listbox", tabIndex: 0, ref: e4.optionsRef };
...
var He = defineComponent({ name: "ListboxOption", props: { as: { type: [Object, String], default: "li" }, value: { type: [Object, String, Number, Boolean] }, disabled: { type: Boolean, default: false }, id: { type: String, default: () => `headlessui-listbox.option-${t()}` } }, setup(t6, { slots: v4, attrs: u6, expose: L4 }) {
  ...
  return () => {
    let { disabled: r4 } = t6, i4 = { active: b4.value, selected: m5.value, disabled: r4 }, { id: n6, value: l4, disabled: d8, ...x4 } = t6, R2 = { id: n6, ref: s3, role: "option", tabIndex: r4 === true ? void 0 : -1, "aria-disabled": r4 === true ? true : void 0, "aria-selected": m5.value, disabled: void 0, onClick: w3, onFocus: k2, onPointerenter: y4, onMouseenter: y4, onPointermove: M3, onMousemove: M3, onPointerleave: h4, onMouseleave: h4 };
...
function ee(r4) {
  requestAnimationFrame(() => requestAnimationFrame(r4));
}
var A2 = Symbol("MenuContext");
function O2(r4) {
  let b4 = inject(A2, null);
  if (b4 === null) {
    let l4 = new Error(`<${r4} /> is missing a parent <Menu /> component.`);
    throw Error.captureStackTrace && Error.captureStackTrace(l4, O2), l4;
  }
  return b4;
}
var Me = defineComponent({ name: "Menu", props: { as: { type: [Object, String], default: "template" } }, setup(r4, { slots: b4, attrs: l4 }) {
  let I2 = ref(1), e4 = ref(null), f5 = ref(null), s3 = ref([]), g5 = ref(""), d8 = ref(null), o4 = ref(1);
  function t6(a7 = (i4) => i4) {
    let i4 = d8.value !== null ? s3.value[d8.value] : null, u6 = O(a7(s3.value.slice()), (v4) => o2(v4.dataRef.domRef)), n6 = i4 ? u6.indexOf(i4) : null;
  ...
  let p9 = { menuState: I2, buttonRef: e4, itemsRef: f5, items: s3, searchQuery: g5, activeItemIndex: d8, activationTrigger: o4, closeMenu: () => {
    ...
    g5.value = "", d8.value = v4, o4.value = u6 != null ? u6 : 1, s3.value = n6.items;
  }, search(a7) {
    let u6 = g5.value !== "" ? 0 : 1;
    g5.value += a7.toLowerCase();
    let v4 = (d8.value !== null ? s3.value.slice(d8.value + u6).concat(s3.value.slice(0, d8.value + u6)) : s3.value).find((x4) => x4.dataRef.textValue.startsWith(g5.value) && !x4.dataRef.disabled), M3 = v4 ? s3.value.indexOf(v4) : -1;
    M3 === -1 || M3 === d8.value || (d8.value = M3, o4.value = 1);
  }, clearSearch() {
    g5.value = "";
  }, registerItem(a7, i4) {
    let u6 = t6((n6) => [...n6, { id: a7, dataRef: i4 }]);
    s3.value = u6.items, d8.value = u6.activeItemIndex, o4.value = 1;
  }, unregisterItem(a7) {
    let i4 = t6((u6) => {
  ...
  return y3([e4, f5], (a7, i4) => {
    var u6;
    p9.closeMenu(), w(i4, h2.Loose) || (a7.preventDefault(), (u6 = o2(e4)) == null || u6.focus());
  }, computed(() => I2.value === 0)), provide(A2, p9), c(computed(() => u(I2.value, { [0]: l.Open, [1]: l.Closed }))), () => {
    let a7 = { open: I2.value === 0, close: p9.closeMenu };
    return H({ ourProps: {}, theirProps: r4, slot: a7, slots: b4, attrs: l4, name: "Menu" });
  };
} });
var Re = defineComponent({ name: "MenuButton", props: { disabled: { type: Boolean, default: false }, as: { type: [Object, String], default: "button" }, id: { type: String, default: () => `headlessui-menu-button-${t()}` } }, setup(r4, { attrs: b4, slots: l4, expose: I2 }) {
  ...
  function g5(o4) {
    r4.disabled || (e4.menuState.value === 0 ? (e4.closeMenu(), nextTick(() => {
      var t6;
  ...
  let d8 = b2(computed(() => ({ as: r4.as, type: b4.type })), e4.buttonRef);
  return () => {
    var i4;
    let o4 = { open: e4.menuState.value === 0 }, { id: t6, ...p9 } = r4, a7 = { ref: e4.buttonRef, id: t6, type: d8.value, "aria-haspopup": "menu", "aria-controls": (i4 = o2(e4.itemsRef)) == null ? void 0 : i4.id, "aria-expanded": e4.menuState.value === 0, onKeydown: f5, onKeyup: s3, onClick: g5 };
    return H({ ourProps: a7, theirProps: p9, slot: o4, attrs: b4, slots: l4, name: "MenuButton" });
  };
} });
var he = defineComponent({ name: "MenuItems", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, id: { type: String, default: () => `headlessui-menu-items-${t()}` } }, setup(r4, { attrs: b4, slots: l4, expose: I2 }) {
  ...
  return () => {
    var u6, n6;
    let t6 = { open: e4.menuState.value === 0 }, { id: p9, ...a7 } = r4, i4 = { "aria-activedescendant": e4.activeItemIndex.value === null || (u6 = e4.items.value[e4.activeItemIndex.value]) == null ? void 0 : u6.id, "aria-labelledby": (n6 = o2(e4.buttonRef)) == null ? void 0 : n6.id, id: p9, onKeydown: s3, onKeyup: g5, role: "menu", tabIndex: 0, ref: e4.itemsRef };
    return H({ ourProps: i4, theirProps: a7, slot: t6, attrs: b4, slots: l4, features: N.RenderStrategy | N.Static, visible: o4.value, name: "MenuItems" });
  };
} });
var ye = defineComponent({ name: "MenuItem", inheritAttrs: false, props: { as: { type: [Object, String], default: "template" }, disabled: { type: Boolean, default: false }, id: { type: String, default: () => `headlessui-menu-item-${t()}` } }, setup(r4, { slots: b4, attrs: l4, expose: I2 }) {
  let e4 = O2("MenuItem"), f5 = ref(null);
  I2({ el: f5, $el: f5 });
  let s3 = computed(() => e4.activeItemIndex.value !== null ? e4.items.value[e4.activeItemIndex.value].id === r4.id : false), g5 = p8(f5), d8 = computed(() => ({ disabled: r4.disabled, get textValue() {
    return g5();
  }, domRef: f5 }));
  onMounted(() => e4.registerItem(r4.id, d8)), onUnmounted(() => e4.unregisterItem(r4.id)), watchEffect(() => {
  ...
  function i4(n6) {
    p9.wasMoved(n6) && (r4.disabled || s3.value || e4.goToItem(a.Specific, r4.id, 0));
  }
  function u6(n6) {
    p9.wasMoved(n6) && (r4.disabled || s3.value && e4.goToItem(a.Nothing));
  }
  return () => {
    let { disabled: n6 } = r4, v4 = { active: s3.value, disabled: n6, close: e4.closeMenu }, { id: M3, ...x4 } = r4;
    return H({ ourProps: { id: M3, ref: f5, role: "menuitem", tabIndex: n6 === true ? void 0 : -1, "aria-disabled": n6 === true ? true : void 0, disabled: void 0, onClick: o4, onFocus: t6, onPointerenter: a7, onMouseenter: a7, onPointermove: i4, onMousemove: i4, onPointerleave: u6, onMouseleave: u6 }, theirProps: { ...l4, ...x4 }, slot: v4, attrs: l4, slots: b4, name: "MenuItem" });
  };
} });
...
function A3(m5) {
  ...
  if (S5 === null) {
    let p9 = new Error(`<${m5} /> is missing a parent <${ge.name} /> component.`);
...
var ge = defineComponent({ name: "Popover", props: { as: { type: [Object, String], default: "div" } }, setup(m5, { slots: S5, attrs: p9, expose: h4 }) {
  var v4;
  let t6 = ref(null);
  h4({ el: t6, $el: t6 });
  let e4 = ref(1), c5 = ref(null), d8 = ref(null), F4 = ref(null), f5 = ref(null), g5 = computed(() => m(t6)), P3 = computed(() => {
    var X3, Y2;
    if (!o2(c5) || !o2(f5))
      return false;
    ...
    return !((X3 = o2(f5)) != null && X3.contains(K3)) && !((Y2 = o2(f5)) != null && Y2.contains(j6));
  }), a7 = { popoverState: e4, buttonId: ref(null), panelId: ref(null), panel: f5, button: c5, isPortalled: P3, beforePanelSentinel: d8, afterPanelSentinel: F4, togglePopover() {
  ...
  let w3 = { buttonId: a7.buttonId, panelId: a7.panelId, close() {
    a7.closePopover();
  } }, y4 = ae(), O3 = y4 == null ? void 0 : y4.registerPopover, [u6, i4] = V(), s3 = p7({ portals: u6, defaultContainers: [c5, f5] });
  function n6() {
    var o4, l4, b4, E6;
    return (E6 = y4 == null ? void 0 : y4.isFocusWithinPopoverGroup()) != null ? E6 : ((o4 = g5.value) == null ? void 0 : o4.activeElement) && (((l4 = o2(c5)) == null ? void 0 : l4.contains(g5.value.activeElement)) || ((b4 = o2(f5)) == null ? void 0 : b4.contains(g5.value.activeElement)));
  }
  ...
  }, true), y3(s3.resolveContainers, (o4, l4) => {
    var b4;
    a7.closePopover(), w(l4, h2.Loose) || (o4.preventDefault(), (b4 = o2(c5)) == null || b4.focus());
  }, computed(() => e4.value === 0)), () => {
    let o4 = { open: e4.value === 0, close: a7.close };
    return h(i4, {}, () => H({ theirProps: { ...m5, ...p9 }, ourProps: { ref: t6 }, slot: o4, slots: S5, attrs: p9, name: "Popover" }));
  };
} });
var je = defineComponent({ name: "PopoverButton", props: { as: { type: [Object, String], default: "button" }, disabled: { type: [Boolean], default: false }, id: { type: String, default: () => `headlessui-popover-button-${t()}` } }, inheritAttrs: false, setup(m5, { attrs: S5, slots: p9, expose: h4 }) {
  let t6 = A3("PopoverButton"), e4 = computed(() => m(t6.button));
  h4({ el: t6.button, $el: t6.button }), onMounted(() => {
    t6.buttonId.value = m5.id;
  }), onUnmounted(() => {
    t6.buttonId.value = null;
  });
  let c5 = ae(), d8 = c5 == null ? void 0 : c5.closeOthers, F4 = Se(), f5 = computed(() => F4 === null ? false : F4.value === t6.panelId.value), g5 = ref(null), P3 = `headlessui-focus-sentinel-${t()}`;
  f5.value || watchEffect(() => {
    t6.button.value = g5.value;
  });
  let a7 = b2(computed(() => ({ as: m5.as, type: S5.type })), g5);
  function w3(n6) {
    var v4, o4, l4, b4, E6;
    if (f5.value) {
      ...
      switch (n6.key) {
        case o.Space:
        case o.Enter:
          n6.preventDefault(), n6.stopPropagation(), t6.popoverState.value === 1 && (d8 == null || d8(t6.buttonId.value)), t6.togglePopover();
          break;
        case o.Escape:
          if (t6.popoverState.value !== 0)
            return d8 == null ? void 0 : d8(t6.buttonId.value);
  ...
  function O3(n6) {
    var v4, o4;
    m5.disabled || (f5.value ? (t6.closePopover(), (v4 = o2(t6.button)) == null || v4.focus()) : (n6.preventDefault(), n6.stopPropagation(), t6.popoverState.value === 1 && (d8 == null || d8(t6.buttonId.value)), t6.togglePopover(), (o4 = o2(t6.button)) == null || o4.focus()));
  }
  function u6(n6) {
  ...
  return () => {
    let n6 = t6.popoverState.value === 0, v4 = { open: n6 }, { id: o4, ...l4 } = m5, b4 = f5.value ? { ref: g5, type: a7.value, onKeydown: w3, onClick: O3 } : { ref: g5, id: o4, type: a7.value, "aria-expanded": t6.popoverState.value === 0, "aria-controls": o2(t6.panel) ? t6.panelId.value : void 0, disabled: m5.disabled ? true : void 0, onKeydown: w3, onKeyup: y4, onClick: O3, onMousedown: u6 };
    return h(Fragment, [H({ ourProps: b4, theirProps: { ...S5, ...l4 }, slot: v4, attrs: S5, slots: p9, name: "PopoverButton" }), n6 && !f5.value && t6.isPortalled.value && h(f2, { id: P3, features: a2.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: s3 })]);
  };
} });
var Ne2 = defineComponent({ name: "PopoverOverlay", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true } }, setup(m5, { attrs: S5, slots: p9 }) {
  ...
  return () => {
    let F4 = { open: h4.popoverState.value === 0 };
    return H({ ourProps: { id: t6, "aria-hidden": true, onClick: d8 }, theirProps: m5, slot: F4, attrs: S5, slots: p9, features: N.RenderStrategy | N.Static, visible: c5.value, name: "PopoverOverlay" });
  };
} });
var We3 = defineComponent({ name: "PopoverPanel", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, focus: { type: Boolean, default: false }, id: { type: String, default: () => `headlessui-popover-panel-${t()}` } }, inheritAttrs: false, setup(m5, { attrs: S5, slots: p9, expose: h4 }) {
  let { focus: t6 } = m5, e4 = A3("PopoverPanel"), c5 = computed(() => m(e4.panel)), d8 = `headlessui-focus-sentinel-before-${t()}`, F4 = `headlessui-focus-sentinel-after-${t()}`;
  h4({ el: e4.panel, $el: e4.panel }), onMounted(() => {
    e4.panelId.value = m5.id;
  }), onUnmounted(() => {
    e4.panelId.value = null;
  ...
  return () => {
    let u6 = { open: e4.popoverState.value === 0, close: e4.close }, { id: i4, focus: s3, ...n6 } = m5, v4 = { ref: e4.panel, id: i4, onKeydown: P3, onFocusout: t6 && e4.popoverState.value === 0 ? a7 : void 0, tabIndex: -1 };
    return H({ ourProps: v4, theirProps: { ...S5, ...n6 }, attrs: S5, slot: u6, slots: { ...p9, default: (...o4) => {
      var l4;
      return [h(Fragment, [g5.value && e4.isPortalled.value && h(f2, { id: d8, ref: e4.beforePanelSentinel, features: a2.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: y4 }), (l4 = p9.default) == null ? void 0 : l4.call(p9, ...o4), g5.value && e4.isPortalled.value && h(f2, { id: F4, ref: e4.afterPanelSentinel, features: a2.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: O3 })])];
    } }, features: N.RenderStrategy | N.Static, visible: g5.value, name: "PopoverPanel" });
  };
} });
var Ae = defineComponent({ name: "PopoverGroup", props: { as: { type: [Object, String], default: "div" } }, setup(m5, { attrs: S5, slots: p9, expose: h4 }) {
  let t6 = ref(null), e4 = shallowRef([]), c5 = computed(() => m(t6));
  h4({ el: t6, $el: t6 });
  function d8(P3) {
    let a7 = e4.value.indexOf(P3);
  ...
  function f5() {
    ...
    if (!P3)
      return false;
    let a7 = P3.activeElement;
    return (w3 = o2(t6)) != null && w3.contains(a7) ? true : e4.value.some((y4) => {
      var O3, u6;
      return ((O3 = P3.getElementById(y4.buttonId.value)) == null ? void 0 : O3.contains(a7)) || ((u6 = P3.getElementById(y4.panelId.value)) == null ? void 0 : u6.contains(a7));
    });
  }
  function g5(P3) {
    for (let a7 of e4.value)
      a7.buttonId.value !== P3 && a7.close();
  }
  return provide(le, { registerPopover: F4, unregisterPopover: d8, isFocusWithinPopoverGroup: f5, closeOthers: g5 }), () => H({ ourProps: { ref: t6 }, theirProps: m5, slot: {}, attrs: S5, slots: p9, name: "PopoverGroup" });
} });
...
var ke = defineComponent({ name: "RadioGroup", emits: { "update:modelValue": (t6) => true }, props: { as: { type: [Object, String], default: "div" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => re2 }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, id: { type: String, default: () => `headlessui-radiogroup-${t()}` } }, inheritAttrs: false, setup(t6, { emit: c5, attrs: u6, slots: E6, expose: d8 }) {
  ...
  return onMounted(() => {
    ...
    return h(Fragment, [...a7 != null && f5.value != null ? e2({ [a7]: f5.value }).map(([T4, G]) => h(f2, K({ features: a2.Hidden, key: T4, as: "input", type: "hidden", hidden: true, readOnly: true, form: l4, name: T4, value: G }))) : [], H({ ourProps: b4, theirProps: { ...u6, ...T(r4, ["modelValue", "defaultValue", "by"]) }, slot: {}, attrs: u6, slots: E6, name: "RadioGroup" })]);
  };
} });
...
var Ee = defineComponent({ name: "RadioGroupOption", props: { as: { type: [Object, String], default: "div" }, value: { type: [Object, String, Number, Boolean] }, disabled: { type: Boolean, default: false }, id: { type: String, default: () => `headlessui-radiogroup-option-${t()}` } }, setup(t6, { attrs: c5, slots: u6, expose: E6 }) {
  ...
  return () => {
    let { id: r4, value: b4, disabled: T4, ...G } = t6, N5 = { checked: v4.value, disabled: m5.value, active: Boolean(f5.value & 2) }, K3 = { id: r4, ref: R2, role: "radio", "aria-checked": v4.value ? "true" : "false", "aria-labelledby": s3.value, "aria-describedby": i4.value, "aria-disabled": m5.value ? true : void 0, tabIndex: e4.value, onClick: m5.value ? void 0 : a7, onFocus: m5.value ? void 0 : n6, onBlur: m5.value ? void 0 : l4 };
    return H({ ourProps: K3, theirProps: G, slot: N5, attrs: c5, slots: u6, name: "RadioGroupOption" });
  };
} });
var we = T3;
var Se2 = E5;
...
var xe2 = defineComponent({ name: "TabGroup", emits: { change: (a7) => true }, props: { as: { type: [Object, String], default: "template" }, selectedIndex: { type: [Number], default: null }, defaultIndex: { type: [Number], default: 0 }, vertical: { type: [Boolean], default: false }, manual: { type: [Boolean], default: false } }, inheritAttrs: false, setup(a7, { slots: v4, attrs: i4, emit: s3 }) {
  ...
  function m5(t6) {
    ...
    if (t6 < 0 || t6 > e4.length - 1) {
      ...
      let p9 = e4.slice(0, t6), G = [...e4.slice(t6), ...p9].find((W2) => f5.includes(W2));
      if (!G)
        return;
      let B3 = (S5 = e4.indexOf(G)) != null ? S5 : r4.selectedIndex.value;
  ...
  provide(U3, r4);
  let R2 = ref({ tabs: [], panels: [] }), y4 = ref(false);
  onMounted(() => {
    y4.value = true;
  }), provide(j5, computed(() => y4.value ? null : R2.value));
...
var ye2 = defineComponent({ name: "Tab", props: { as: { type: [Object, String], default: "button" }, disabled: { type: [Boolean], default: false }, id: { type: String, default: () => `headlessui-tabs-tab-${t()}` } }, setup(a7, { attrs: v4, slots: i4, expose: s3 }) {
  ...
  function w3() {
    var e4;
    y4.value || (y4.value = true, !a7.disabled && ((e4 = o2(n6)) == null || e4.focus(), l4.setSelectedIndex(b4.value), t3(() => {
      y4.value = false;
    })));
  }
  function h4(e4) {
...
var ge2 = defineComponent({ name: "TabPanel", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, id: { type: String, default: () => `headlessui-tabs-panel-${t()}` }, tabIndex: { type: Number, default: 0 } }, setup(a7, { attrs: v4, slots: i4, expose: s3 }) {
  ...
  return () => {
    var t6;
    let r4 = { selected: m5.value }, { id: R2, tabIndex: y4, ...w3 } = a7, h4 = { ref: n6, id: R2, role: "tabpanel", "aria-labelledby": (t6 = o2(l4.tabs.value[b4.value])) == null ? void 0 : t6.id, tabIndex: m5.value ? y4 : -1 };
...
function L2(e4, t6, i4, n6, a7, l4) {
  ...
  return d7(e4, ...a7), m4(e4, ...t6, ...i4), s3.nextFrame(() => {
    d7(e4, ...i4), m4(e4, ...n6), s3.add(F3(e4, (u6) => (d7(e4, ...n6, ...t6), m4(e4, ...a7), o4(u6))));
...
var he2 = defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e4, { emit: t6, attrs: a7, slots: s3, expose: h4 }) {
  ...
  h4({ el: d8, $el: d8 });
  let { show: v4, appear: A4 } = Te(), { register: D, unregister: H5 } = ge3(), i4 = ref(v4.value ? "visible" : "hidden"), I2 = { value: true }, c5 = t(), y4 = { value: false }, P3 = Q3(() => {
    !y4.value && i4.value !== "hidden" && (i4.value = "hidden", H5(c5), S5());
  });
  onMounted(() => {
    let o4 = D(c5);
    onUnmounted(o4);
  ...
  let j6 = g4(e4.enter), M3 = g4(e4.enterFrom), X3 = g4(e4.enterTo), _3 = g4(e4.entered), Y2 = g4(e4.leave), Z2 = g4(e4.leaveFrom), ee2 = g4(e4.leaveTo);
  onMounted(() => {
    watchEffect(() => {
      if (i4.value === "visible") {
        let o4 = o2(d8);
  ...
  function te2(o4) {
    ...
    !p9 || !(p9 instanceof HTMLElement) || E6 || (y4.value = true, v4.value && r4(), v4.value || f5(), o4(v4.value ? L2(p9, j6, M3, X3, _3, (V3) => {
      y4.value = false, V3 === g3.Finished && l4();
    }) : L2(p9, Y2, Z2, ee2, _3, (V3) => {
      y4.value = false, V3 === g3.Finished && (L3(P3) || (i4.value = "hidden", H5(c5), S5()));
    })));
  }
  return onMounted(() => {
    watch([v4], (o4, E6, p9) => {
    ...
    let { appear: o4, show: E6, enter: p9, enterFrom: V3, enterTo: Ce2, entered: be3, leave: ye3, leaveFrom: Ee2, leaveTo: Ve2, ...U4 } = e4, ne = { ref: d8 }, re3 = { ...U4, ...A4.value && v4.value && c2.isServer ? { class: normalizeClass([a7.class, U4.class, ...j6, ...M3]) } : {} };
...
export {
  Ue as Combobox,
  _e as ComboboxButton,
  Je as ComboboxInput,
  qe as ComboboxLabel,
  Ge as ComboboxOption,
  We as ComboboxOptions,
  Ue2 as Dialog,
